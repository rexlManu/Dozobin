...
export function MarkdownView({
    ...
    return (
        <div
            className={cn(
                'max-w-[70ch] text-[15px] leading-[1.7] text-foreground',
                '[&>*+*]:mt-4',
                ...
                '[&_a]:underline [&_a]:decoration-border-strong [&_a]:underline-offset-4 hover:[&_a]:decoration-foreground',
                '[&_li]:mt-1.5 [&_li]:text-foreground/90 [&_ol]:list-decimal [&_ol]:pl-5 [&_ul]:list-disc [&_ul]:pl-5',
                '[&_blockquote]:border-l-2 [&_blockquote]:border-primary [&_blockquote]:pl-4 [&_blockquote]:text-muted-foreground',
                '[&_hr]:border-border',
                '[&_table]:w-full [&_table]:border-collapse [&_table]:text-sm',
                '[&_th]:border-b [&_th]:border-border-strong [&_th]:pb-2 [&_th]:text-left [&_th]:font-medium',
